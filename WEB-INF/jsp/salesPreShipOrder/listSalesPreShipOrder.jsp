...
function view(id) {
	var url = "viewCreateSalesPreShipOrder.do?id=" + id;
...
function addSalesPreshiporder(){
	var url = "newSalesPreshiporder.do";
	window.location.href = url;
}
</script>
<html:form action="listSalesPreshiporder" styleId="formId">
...
<page:form action="listSalesPreshiporder.do" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">

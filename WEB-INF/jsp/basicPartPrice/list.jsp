...
<script type="text/javascript">
	 function addBasicPartPrice() {
		v = window.showModalDialog(
			'showDialog.do?title=Price.new.title&newBasicPartPriceMaintenanceAction.do' , 
	...
	function edit(id) {
		v = window.showModalDialog(
			'showDialog.do?title=Price.edit.title&editBasicPartPriceMaintenanceAction.do?id=' + id , 
			null, 'dialogWidth:700px;dialogHeight:450px;status:no;help:no;scroll:no');
		if (v) {
...
<html:form action="/listBasicPartPriceMaintenanceAction.do" styleId="formId">
...
<page:form action="/listBasicPartPriceMaintenanceAction.do" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">
				<th>

...
<xml id="data">
<data>
  <logic:iterate id="X_PC" name="X_EXPENSECATEGORYLIST">
  <category id="${X_PC.id}" name="<bean:write name="X_PC" property="description"/>">
    ...
    <logic:iterate id="X_PSC" name="X_PC" property="enabledExpenseSubCategoryList">
...
<html:form action="update${X_RULECONDITION.rule.type.prefixUrl}RuleCondition.do" onsubmit="return validateRuleConditionForm(this);">

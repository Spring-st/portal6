...
--%>
	<table width="430px" height="241px" align="center"  border="1" cellspacing="0" cellpadding="0" >
		<tr height="21%" >
			<%--<td width="21%"><img width="80" height="44"  src='images/Lear_log_proc.jpg'></td>--%>
		...
		<tr height="10%" align="center">
			...
			<td width="45%"  rowspan="2" style="font-weight: bold; font-size: 20px;">${box.part.id}</td>
			<td width="8%" >车&nbsp;&nbsp;&nbsp;型</td>
		...
		<tr height="17%" align="center">
			...
			<td width="45%" colspan="3"><img  style="width: 370px; height: 36px;" src='${path}/CreateBarCode?msg=${box.lot.id}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=160&moduleWidth=300'></td>
		</tr>
	</table>

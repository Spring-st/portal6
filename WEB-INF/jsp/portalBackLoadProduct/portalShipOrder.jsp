...
function view(id) {
	var url = "viewPortalShipOrderTwoProduct.do?id=" + id;
...
function addCondiment(){
	var url = "newPortalShipOrderTwoProduct.do";
	window.location.href = url;
}
//根据发货单Id去删除数据
function deleteDelivery(id){
	var url="deleteDeliveryJit.do?id="+id;
	window.location.href=url;
}
</script>
<html:form action="listShippingOrderProduct" >
...
<page:form action="listShippingOrderProduct.do" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">
				<th>

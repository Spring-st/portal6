...
<script type="text/javascript">
	function printCodeList(psoId) {
					...
					window.location.href="printPortalShipOrderPartCodeListProduct.do?supplierBatchStr="+supplierBatchStr+"&id="+psoId+"&poipBoxIds="+poipBoxIds;		
	...
	function printSPList(psoId) {
		window.location.href="printPortalShipOrderViewProduct.do?id="+psoId;
	}
	...
	function withdraw(psoId){
		var url = "withdrawPortalShipOrderTwoProduct.do?id=" + psoId;
		window.location.href = url;
	}
	function goTo(id){
		var url = "listShippingOrderProduct.do";
		window.location.href = url;
	}
	function createPortalShipOrderIpTwo(psoId) {
		
		window.location.href="createPortalShipOrderIpTwoProduct.do?id="+psoId;
	}
	function closeEnabled(id){
		window.location.href="updateJitCloseIsEnabled.do?id="+id;
	}
	function openEnabled(id){
		window.location.href="updateJitOpenIsEnabled.do?id="+id;
	}
</script>
<html:form action="/viewPortalShipOrderTwoProduct" method="post">
	<table width="100%">
	<tr>
...
<page:form action="/viewPortalShipOrderTwoProduct">		

   ...
   function RecordPrint(){
		...
		var len = el.length;   
  		...
  		if(count==0){
  			...
  			window.location.href = "RecordBeforePrint.do?array="+str;
}		
//-->
</script>
<html:form action="/listProduceRejectedMaterialBefore.do" styleId="formId">
	...
	<input type="hidden" name="fields" value="prm.box.part.oldCode" desc="原厂编号"/>
...
<hr />
<page:form action="/listProduceRejectedMaterialBefore.do" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">

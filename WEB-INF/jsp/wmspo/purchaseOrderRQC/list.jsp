...
<style>
<!--
 .data td{ white-space: nowrap; }
-->
</style>
<script type="text/javascript">
<!--
    function edit(id) {
		window.location.href="editPurchaseOrderRQC.do?id=" + id;
	}
    function print(){
			var form=document.purchaseOrderRQCQueryForm;
			form.action = "pirntPurchaseOrderRQCItem.do";
			form.submit();
	}
	
//-->
</script>
<html:form action="/listPurchaseOrderRQC.do" styleId="formId">
	<input type="hidden" name="fields" value="" desc="请选择"/>
	<input type="hidden" name="fields" value="rqc.po_number" desc="采购单号"/>
	<input type="hidden" name="fields" value="rqc.line" desc="行号"/>
	<input type="hidden" name="fields" value="rqc.boxId.lot.id" desc="条码编号"/>
...
<page:form action="/listPurchaseOrderRQC.do" method="post">
		<table class="data"  style="word-break: keep-all; width: 1300px;">
			<thead>
				<tr bgcolor="#9999ff">
					<th>采购单号</th>
					<th>行号</th>

...
function view(id) {
		var url = "viewPurchaseOrderActualReceipts.do?id=" + id;
...
<page:form action="listPurchaseOrderActualReceipts.do" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">

...
<td>
<c:if test="${X_OBJECT.status_rqc != '3'}"><input type="checkbox" name="ids" value="${X_OBJECT.lot.id}" onclick="productbox_click();"/></c:if>
<c:if test="${X_OBJECT.status_rqc == '3'}"><input type="checkbox" disabled="disabled"/></c:if>
</td>

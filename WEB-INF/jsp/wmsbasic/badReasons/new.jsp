...
<html:form action="/insertBadReasons.do" >
<div style="font-size: 20px; color: blue; text-align: center; margin: 10px 0px; font-weight: bold;">不合格原因新增</div>
	<table width=90% border=0 cellpadding=4 cellspacing=0>
		<tr>
			<td class="bluetext">不合格原因:</td>
			<td><html:textarea property="describe" cols="40" rows="3"/><span class="required">*</span></td>
		</tr>
		 <tr>
		...
		<tr>
			...
			<td><html:textarea property="remark" cols="40" rows="3" /></td>
		</tr>
		<tr>

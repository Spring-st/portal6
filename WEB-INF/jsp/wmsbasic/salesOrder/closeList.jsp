...
<script type="text/javascript">
	...
	function salesOrderItemClose(){
       	...
       	r = confirm("确认关闭这些销售订单吗？");
       	if(r){
       	  $.ajax({
			type : "POST", //请求方式        
			url : "salesOrderItemClose.do", //请求路径        
			cache : false,
			data : "arrays=" + str, //传参        
			dataType : 'json', //返回值类型        
			success : function(json) {
				 window.location.href = "listCloseSalesOrderItem.do";
           		}
	  		});
       	 }
	 }
</script>
<html:form action="listCloseSalesOrderItem" styleId="formId">
...
<page:form action="listCloseSalesOrderItem" method="post">

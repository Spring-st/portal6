...
function upPurchase(){
	...
	document.supplierPartQueryForm.submit();
}       
//-->
</script>
<html:form action="/upLoadFileSupplierPartSamplingRatio.do" enctype="multipart/form-data">
<div align="center"><h3 style="color:blue">供应物料抽检比例导入</h3></div>

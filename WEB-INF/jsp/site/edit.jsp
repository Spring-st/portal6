...
-->
<tr>
  <td class="bluetext"><bean:message key="site.logo"/>:123</td>
  <td>
  	<html:file  accept="image/gif,image/jpeg,image/jpg,image/png" property="logo" onchange="updateImage(this.value);"/>
  </td>
</tr>
<tr>
  <td></td>

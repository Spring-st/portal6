...
<br/>
	...
	<%--
	 <table width="513px" height="346px" align="center"  border="0" cellspacing="0" cellpadding="0" >
		<tr height="21%" >
		...
		<tr height="14%" align="center">
			...
			<td rowspan="3">
				<img  style=" width: 166px;height: 163px;" src='${path}/CreateQrCode?msg=${box.lot.id}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=80&moduleWidth=80'> 
			</td>
		</tr>
		<tr height="11%" align="center">
			<td width="12%">批次号</td>
			<td width="45%" colspan="5">${box.huCodeOrderNumber}</td>
		</tr>

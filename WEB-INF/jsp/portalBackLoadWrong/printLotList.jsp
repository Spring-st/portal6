    ...
    function printCodeMax(){
	    ...
	    var el = document.getElementsByName('ids');  
  		...
  		for(var i=0; i<len; i++){   
			...
			window.location.href = "printCodePurchaseOrderInspectionPendingItemWrong.do?str="+str.toString();
	}
	function printQrCodeMax(){
		 var el = document.getElementsByName('ids');  
	  		...
	  		for(var i=0; i<len; i++){   
				...
				window.location.href = "printQrCodeMax.do?str="+str.toString();
	}
	 function printCodeMin(){
	    ...
	    var el = document.getElementsByName('ids');  
  		...
  		for(var i=0; i<len; i++){   
			...
			//window.location.href = "printCodePurchaseOrderInspectionPendingItem.do?supplierBatch="+supplierBatch+"&str="+str.toString();
			window.location.href = "printCodePurchaseOrderInspectionPendingItemWrongMin.do?str="+str.toString();
	}
	 function printQrCodeMin(){
		 var el = document.getElementsByName('ids');  
	  		...
	  		for(var i=0; i<len; i++){   
				...
				//window.location.href = "printCodePurchaseOrderInspectionPendingItem.do?supplierBatch="+supplierBatch+"&str="+str.toString();
				window.location.href = "printQrCodeMin.do?str="+str.toString();
	 }
	 function printCodeZhong(){
	    ...
	    var el = document.getElementsByName('ids');  
  		...
  		for(var i=0; i<len; i++){   
			...
			//window.location.href = "printCodePurchaseOrderInspectionPendingItem.do?supplierBatch="+supplierBatch+"&str="+str.toString();
			window.location.href = "printCodePurchaseOrderInspectionPendingItemWrongZhong.do?str="+str.toString();
	}
	 function printQrCodeZhong(){
		 var el = document.getElementsByName('ids');  
	  		...
	  		for(var i=0; i<len; i++){   
				...
				window.location.href = "printQrCodeItemWrongZhong.do?str="+str.toString();
	 }
   function uncheckAll() {  
        var el = document.getElementsByName('ids');   
  		var len = el.length;   
...
//-->
 ...
 <html:form action="/printPortalShipOrderPartCodeListWrong"  method="post">
 </html:form>
 <page:form action="/printPortalShipOrderPartCodeListWrong"  method="post">
<table width="100%">
<tr><td>
...
<tr><td>
        ...
        --%><c:if test="${sessionScope.LOGIN_USER.locale=='zh'}"><input type="button" value="打印二维码小标签"  onclick="printQrCodeZhong()"/></c:if>
        <c:if test="${sessionScope.LOGIN_USER.locale=='zh'}"><input type="button" value="打印二维码中标签"  onclick="printQrCodeMax()"/></c:if>
        <c:if test="${sessionScope.LOGIN_USER.locale=='zh'}"><input type="button" value="打印二维码大标签"  onclick="printQrCodeMin()"/></c:if>
        
        <c:if test="${sessionScope.LOGIN_USER.locale=='en'}"><input type="button" value="Print label Min"  onclick="printCodeMin()"/></c:if>
        <c:if test="${sessionScope.LOGIN_USER.locale=='en'}"><input type="button" value="Print label Min"  onclick="printCodeZhong()"/></c:if>

	...
	<div  align="center" class="transparent_class"  style="margin-left:30%;margin-top:-15%;z-index: 2;position: absolute; width: 453px;height: 265px; padding-top: 0px ">
	 ...
	 <table width="382px" height="170px" align="center"  border="0" cellspacing="0" cellpadding="0" >
		...
		<tr height="10%" align="center">
			...
			<td width="45%"  rowspan="2"  colspan="4" style="font-weight: bold; font-size: 15px;">${box.part.id}</td>
			<td width="12%">车&nbsp;&nbsp;&nbsp;型</td>
		...
		<tr height="14%" align="center">
			...
			<td rowspan="3">
				<img  style=" width: 100px;height: 75px;" src='${path}/CreateQrCode?msg=${box.lot.id}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=80&moduleWidth=80'> 
			</td>
		</tr>
		<tr height="11%" align="center">
			<td width="12%">打印日期</td>
			<td width="45%" colspan="5">${X_DATE}</td>
		</tr>
		<tr height="17%" align="center">
			<td>检&nbsp;&nbsp;&nbsp;验</td>
			<td width="14%" colspan="2">&nbsp;</td>
			<td width="12%" colspan="2">批次号</td>
	...
	<tr style="width: 100%; height: 50%;" align="center">
		<c:forEach var="box" items="${X_RESULTLIST}" varStatus="status">
			<td style="width: 50%; height: 50%;">
				<table width="514px" height="346px" align="center" border="1"
					...
					<tr height="11%" align="center">
						...
						<td width="17%" style="font-weight: bold; font-size: 20px;">
							<fmt:formatNumber>${box.number}</fmt:formatNumber>
							${box.part.unit}
						</td>
					</tr>
					<tr height="14%" align="center">
					...
					<tr height="14%" align="center">
						...
						<td rowspan="3">
							<img style="width: 130px; height: 130px;"
								src='${path}/CreateQrCode?msg=${box.lot.id}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=80&moduleWidth=80'>
						</td>
					</tr>
					<tr height="12%" align="center">
						...
						<td width="45%" colspan="5" style="font-weight: bold; font-size: 15px;">
							${box.huCodeOrderNumber}
						</td>
					</tr>
					<tr height="17%" align="center">
						<td>
						...
						<td width="12%" style="font-weight: bold; font-size: 15px;">
							${fn:substring(box.lot.id,fn:length(box.lot.id)-4,fn:length(box.lot.id))}
						</td>
					</tr>
				</table>
			</td>

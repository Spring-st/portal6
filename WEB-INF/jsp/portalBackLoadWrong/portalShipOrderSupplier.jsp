...
function view(id) {
	var url = "viewPortalShipOrderTwoWrong.do?id=" + id+"&GrantedSite=2";
...
<html:form action="shippingOrderWrongSupplier" >
...
<page:form action="shippingOrderWrongSupplier.do" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">
				<th>

			  ...
			  var el = document.getElementsByName('ids');
  			 ...
  			 if((el[i].type=="checkbox") && (el[i].checked== true)){
				 if(el[i].id!="checkAll"){
       		   ...
       		   r = confirm("确认要冻结一下条码吗？");
       		   if(r){
       			   $.ajax({
					type : "POST", //请求方式        
					url : "updatePurchaseOrderBoxFreeze.do", //请求路径        
					cache : false,
					data : "arrays=" + str, //传参        
					dataType : 'json', //返回值类型        
						 success : function(json) {
						 window.location.href = 'purchaseOrderBoxFreezeList.do';
        	  			 }
	 				 });
       		    }
		}
...
<html:form action="/purchaseOrderBoxFreezeList.do" styleId="formId">
	...
	<input type="hidden" name="fields" value="pb.po_supp" desc="供应商编码"/>
...
<page:form action="/purchaseOrderBoxFreezeList.do" method="post">
	<table class="data">
		<thead>

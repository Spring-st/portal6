			  ...
			  var el = document.getElementsByName('ids');
  			 ...
  			 if((el[i].type=="checkbox") && (el[i].checked== true)){
				 if(el[i].id!="checkAll"){
       		   ...
       		   r = confirm("确认要解冻一下条码吗？");
       		   if(r){
       			    $.ajax({
					type : "POST", //请求方式        
					url : "updatePurchaseOrderBoxFreezeOpen.do", //请求路径        
					cache : false,
					data : "arrays=" + str, //传参        
					dataType : 'json', //返回值类型        
						 success : function(json) {
						 window.location.href = 'purchaseOrderBoxFreezeOpenList.do';
        	  			 }
	 				 });
       		    }
		}
...
<html:form action="/purchaseOrderBoxFreezeOpenList.do" styleId="formId">
...
<page:form action="/purchaseOrderBoxFreezeOpenList.do" method="post">
	<table class="data">
		<thead>

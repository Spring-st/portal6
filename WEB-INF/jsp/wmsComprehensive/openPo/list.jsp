...
<!--
		 function openPo(){
       	...
       	r = confirm("确认打开这些采购单吗？");
       	if(r){
       	  $.ajax({
			type : "POST", //请求方式        
			url : "purchaseOrderOpen.do", //请求路径        
			cache : false,
			data : "arrays=" + str, //传参        
			dataType : 'json', //返回值类型        
			success : function(json) {
				 window.location.href = "listPurchaseOrderOpen.do";
           		}
	  		});
       	 }
	 }
...
<html:form action="/listPurchaseOrderOpen.do" styleId="formId">
...
<page:form action="/listPurchaseOrderOpen.do" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">

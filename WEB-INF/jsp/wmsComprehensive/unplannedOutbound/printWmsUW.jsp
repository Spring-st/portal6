...
<script> 
	...
	{ 
		...
		//window.location.href="closeWmsPlanToGoOut.do?id=${x_planToGoOut.id}";
	} 
	...
	function window.close(){
		window.location.href="listWmsPlanToGoOut.do";
	}
	function shuaxin(){
		location = location;
	}
...
<html:hidden property="wmsGoOut_id" value="${x_planToGoOut.id}"/>
 <table width="100%" style="border: 1px solid;" border="0">
   		<tr>
   			<td colspan="3"></td>
   		</tr>
   		<tr>
   			<td colspan="7" align="center"><span style="font-size: 24px;"><strong>非计划出库单</strong></span></td>
   		</tr>
   		<tr>
  	 		<td colspan="7" align="center"><img width=320 src='/wmsv5_km/CreateBarCode?msg=${x_planToGoOut.code}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=500&moduleWidth=500'></td>
  	 	</tr>
  	 	<tr>
   		<td>&nbsp;</td>
   		<td colspan="2" class="bluetext" style="font-size: 15px;">申请日期：&nbsp;${x_planToGoOut.date}</td>
   		<td colspan="2" class="bluetext" style="font-size: 15px;">申请人：&nbsp;${x_planToGoOut.applicant.name}</td>
   		<td colspan="2" align="left" class="bluetext" style="font-size: 15px;">非计划出库日期：&nbsp;<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%></td>
   		</tr>
   		<%--<tr>
   		<td>&nbsp;</td>
   		<td class="bluetext" colspan="6" style="font-size: 15px;">非计划出库类别：（非计划出库类别为"试作品入库时"，需提交到品管科）</td>
   		</tr>
   		<tr>
   		<td>&nbsp;</td>
   		...
   		<td>${x_planToGoOut.reason_code.department_cost}&nbsp;</td>
   		<td colspan="1" class="bluetext">费用科目：&nbsp;</td>
   		<td>${x_planToGoOut.reason_code.expenses_course}</td>
   		</tr>
   		<tr>
   		<td>&nbsp;</td>
	...
	<table class="data">
	       <tr align="center">
	        <td style="font-size: 15px;" colspan="9">非计划出库申请明细</td>
	       </tr>
   	       ...
   	       <tbody id="item_datatable">
   	        ...
   	        <c:forEach var="X_OBJECT" items="${x_subs}" varStatus="status">
   	          <tr align="center">
   	...
   	<table width="100%" style="border: 1px solid;" border="0">
   	<tr>
   	  <td class="bluetext" colspan="3" >非计划出库主要原因：</td>
   	</tr>
   	<tr><td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${x_planToGoOut.remark}</td></tr>

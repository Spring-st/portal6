...
<script type="text/javascript">
	  function edit(id){
			...
			'showDialog.do?title=purchaseOrderRqcDetermine.title&getPlanToGoOutByBox.do?array='+id, 
...
<html:form action="/listWmsPlanToGoOutScann.do" >
...
<page:form action="/listWmsPlanToGoOutScann.do" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">

...
<script type="text/javascript">
		 function validateunplanToGoOutScannForm(){
...
<html:form action="/planToGoOutScann.do" onsubmit="return validateunplanToGoOutScannForm();">
<input type="hidden" value="${x_planToGoOut.id}" name="code"/>
<div align="center"><span style="font-size: 20px;"><strong>勾选批次出库</strong></span></div>
    	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">
		...
		<tbody id="datatable">
			 <c:forEach items="${x_list}" var="x_obj">
			 	<tr>
			 		<td><input type="checkbox" name="ids" value="${x_obj.box_id.id}" onclick="productbox_click();"/></td>

...
<td> 
<c:if test="${X_OBJECT.location.code==null}"><input type="checkbox" name="ids" value="${X_OBJECT.lot.id}" onclick="productbox_click();"/></c:if>
<c:if test="${X_OBJECT.location.code!=null}"><input type="checkbox" disabled="disabled"/></c:if>
</td>

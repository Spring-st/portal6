		...
		if(r){
			  var el = document.getElementsByName('ids');
  			 ...
  			 if((el[i].type=="checkbox") && (el[i].checked== true)){
  		       ...
  		       $.ajax({         
                type:"POST", //请求方式        
                url:"boxAbolitionByAjax.do", //请求路径        
                cache: false,           
                data:"ids="+str,  //传参        
                dataType: 'json',   //返回值类型        
                success:function(date){
                	window.location.href="listBoxAbolition.do";
			   } 
            })
		}
	}
</script>
<html:form action="/listBoxAbolition.do" styleId="formId">
	...
	<input type="hidden" name="fields" value="pb.part.oldCode" esc="供应商编号"/>
...
<page:form action="/listBoxAbolition.do" method="post">
	<table class="data">
		<thead>

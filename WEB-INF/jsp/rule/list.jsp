...
<table width="100%" border="0" cellpadding="4" cellspacing="0">
  <tbody>
    <tr>
      ...
      <td colspan="4"><html:select property="site.value" onchange="ruleQueryForm.submit();"><html:optionsCollection property="site.list" value="id" label="name"/></html:select></td>
    </tr>
    <tr>

...
<script type="text/javascript">
	...
	function closeCustomerPlan(id) {
		window.location.href = "customerPlanCloseOrOpen.do?id="+id+"&type=1";
	}
	function openCustomerPlan(id) {
		window.location.href = "customerPlanCloseOrOpen.do?id="+id+"&type=0";
	}
</script>
<html:form action="listCustomerPlanCloseOrOpen" styleId="formId">
...
<page:form action="listCustomerPlanCloseOrOpen" method="post">
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">

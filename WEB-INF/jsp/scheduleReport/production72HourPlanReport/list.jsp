...
<html:form action="/listProduction72HourPlan.do" styleId="formId">
	<input type="hidden" name="fields" value="" desc="请选择" />
	<input type="hidden" name="fields" value="hour.carkind" desc="车种" />
	<input type="hidden" name="fields" value="hour.asn" desc="值" />
...
<page:form action="/listProduction72HourPlan.do" method="post">
	<div style="width: 2500px;">
		<!--表头-->
		<div id="mytable" style="width: 100%; padding-right: 17px;">
			<table class="data" width="2590px" word-break="keep-all;">
				<thead>
					<tr bgcolor="#9999ff">
					...
					<page:desc>
						...
						<th nowrap="nowrap" width="35px">值</th>
						<th nowrap="nowrap" width="38px">M-1</th>
						<th nowrap="nowrap" width="31px">当月</th>
						<th nowrap="nowrap" width="29px">D-1</th>
						<th nowrap="nowrap" width="29px">PBS</th>
						<th nowrap="nowrap" width="32px">PRJ</th>
						<th nowrap="nowrap" width="32px">WBS</th>
						<th nowrap="nowrap" width="48px">${X_DD}SUM</th>
		...
		<div id="container"
			style="width: 2500px; overflow-y: scroll; height: 390px;">
			<table width="3925px">
				<tbody id="datatable">

...
<!--
	function selectUser() {
		v = window.showModalDialog(
			'showDialog.do?title=ruleConsequence.selectApprover.title&select${X_RULECONSEQUENCE.rule.type.prefixUrl}ConsequenceUser.do', 
	...
	function selectSuperior() {
		v = window.showModalDialog(
			'showDialog.do?title=ruleConsequence.selectSuperior.title&select${X_RULECONSEQUENCE.rule.type.prefixUrl}ConsequenceUser.do', 
			null, 'dialogWidth:650px;dialogHeight:500px;status:no;help:no;scroll:no');
		if (v) {
...
<html:form action="insert${X_RULECONSEQUENCE.rule.type.prefixUrl}RuleConsequence.do" onsubmit="return validateRuleConsequenceForm(this);">

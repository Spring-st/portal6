			...
			trString+="<td><select name='field["+id+"]' >";
			 for(var i=0; i<fields.length; i++){
				 if(field != '' && field == fields[i].value){
					 trString+="<option selected='selected' value='"+fields[i].value+"'>"+fields[i].desc+"</option>";
				 }else{
					 trString+="<option value='"+fields[i].value+"'>"+fields[i].desc+"</option>";
				 }
			 }
	...
	<tr>
		...
		<td>
			<table id="simQuery" border="0">
				<tr>
					<td>
						<table id="queryContent" border="0" width="600">
						<html:select property="height">
							<html:option value="entity.part.highQty">高储库存</html:option>
							<html:option value="entity.part.lowQty">低储库存</html:option>
							<html:option value="entity.part.securityQty">安全库存</html:option>
							<html:option value="entity.currentQty">当前库存</html:option>
							</html:select>&nbsp;&nbsp;
							<html:select property="eq">
							<html:option value=">" >大于</html:option>
							<html:option value="<" >小于</html:option>
							<html:option value="=" >等于</html:option>
							</html:select>&nbsp;&nbsp;
							<html:select property="low">
							<html:option value="entity.part.highQty">高储库存</html:option>
							<html:option value="entity.part.lowQty">低储库存</html:option>
							<html:option value="entity.part.securityQty">安全库存</html:option>
							<html:option value="entity.currentQty">当前库存</html:option>

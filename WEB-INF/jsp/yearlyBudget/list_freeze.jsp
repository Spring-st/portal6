...
<!--
	function doFreeze() {
		...
		with(document.listYearlyBudget_freeze_yearlyBudgetQueryForm_again)
		{
			freeze.value="true";
			
			//listYearlyBudget_freeze_yearlyBudgetQueryForm_again    yearlyBudgetQueryForm_again
			
			document.listYearlyBudget_freeze_yearlyBudgetQueryForm_again["org.apache.struts.taglib.html.TOKEN"].value=

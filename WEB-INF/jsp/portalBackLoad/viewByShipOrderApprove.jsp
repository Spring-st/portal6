...
<table width="100%">
<tr>
<td><h3 style="color:blue"><bean:message key="approveRequest.approveList.title" /></h3></td>
</tr>
</table>
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="data" align="left">
<thead>
	<tr bgcolor="#9999ff">

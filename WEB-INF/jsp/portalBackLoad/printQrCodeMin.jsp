	...
	<div  align="center" class="transparent_class"  style="margin-left:30%;margin-top:-15%;z-index: 2;position: absolute; width: 453px;height: 265px; padding-top: 0px ">
	 ...
	 <table width="382px" height="170px" align="center"  border="0" cellspacing="0" cellpadding="0" >
		...
		<tr height="22%" align="center">
			...
			<td width="56%"  rowspan="2"  colspan="4" style="font-weight: bold; font-size: 15px;">${box.part.id}</td>
			<td width="11%">车&nbsp;&nbsp;&nbsp;型</td>
			<td width="22%" style="font-weight: bold;">${box.part.productSpecifications}</td>
		</tr>
		<tr  align="center">
			<td width="11%">数&nbsp;&nbsp;&nbsp;量</td>
			<td width="22%" style="font-weight: bold;"><fmt:formatNumber>${box.number}</fmt:formatNumber>${box.part.unit}</td>
		</tr>
		<tr height="11%" align="center">
			<td width="11%">零件名称</td>
		...
		<tr height="49%" align="center">
			...
			<td rowspan="3" valign="middle">
				<img  style=" width: 75px;height: 76px; " src='${path}/CreateQrCode?msg=${box.lot.id}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=80&moduleWidth=80'> 
			</td>
		</tr>
		<tr  align="center">
			<!--  
			...
			-->
			<td width="11%">批次号</td>
			<td width="50%" colspan="5">${box.huCodeOrderNumber}</td>
		</tr>
		<tr  align="center">
			<td>检&nbsp;&nbsp;&nbsp;验</td>

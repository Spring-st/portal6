...
function view(id) {
	...
	window.location.href = url;
 	...
 	function generate(){
 		//var fromValue=document.getElementById("selectFromValue").value;
 		//var toValue=document.getElementById("selectToValue").value;
 		//alert(fromValue);
 		//alert(toValue);
		...
		var url='createPortalShipPurchaseOrder.do?list='+list;
		window.location=url;
...
<page:form action="listPurchase.do" method="post">

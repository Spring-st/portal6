...
<html:form action="/insertEdiProduction" styleId="ediProduction" onsubmit="return validateForm(this)">
	<table width=90% border=0 cellpadding=4 cellspacing=0>
		...
		<tr>
			<td class="bluetext"><bean:message key="ediproduction.time" />HHmmss:</td>
			<td><html:text property="time" /><span class="required">*</span></td>
		</tr>
		<tr>

...
function goTo(){
		var url = "listEdiProductionAction.do";
		window.location.href = url;
	}
</script>
<html:form action="/listJitProductionPlanViewAction.do">
	<input type="hidden" name="productionId" id="productionId" value="${productionId}"/>
	 <input type="hidden" name="fields" value="" desc="请选择"/>
	<input type="hidden" name="fields" value="entity.fatherPart.id" desc="父件编码"/>
...
<hr />
<page:form action="/listJitProductionPlanViewAction.do" method="post">
<input type="hidden" name="productionId" id="productionId" value="${productionId}"/>
	<table class="data">
		<thead>
			<tr bgcolor="#9999ff">

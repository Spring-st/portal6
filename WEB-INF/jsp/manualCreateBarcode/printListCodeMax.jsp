...
<c:forEach var="code" items="${X_CODELIST}" varStatus="status" >
	...
	<table width="514px" height="347px;"  border="1" cellspacing="0" cellpadding="0"  >
		...
		<tr height="10%" align="center">
			...
			<td width="45%"  rowspan="2" style="font-weight: bold; font-size: 25px;">${code.part}</td>
			<td width="8%">车&nbsp;&nbsp;&nbsp;型</td>
			<td width="17%" style="font-weight: bold;font-size: 20px;">${code.model}</td>
		</tr>
		<tr height="11%" align="center">
			<td width="8%">数&nbsp;&nbsp;&nbsp;量</td>
			<td width="17%" style="font-weight: bold;font-size: 20px;"><fmt:formatNumber>${code.qty}</fmt:formatNumber>${code.partUnit}</td>
		</tr>
		<tr height="11%" align="center">
			<td width="10%">零件名称</td>
		...
		<tr height="17%" align="center">
			...
			<td width="45%" colspan="3"><img  style="width: 430px; height: 70px;" src='${path}/CreateBarCode?msg=${code.part}/<fmt:formatDate value="${code.serialDate}" pattern="yyMMdd"/>/${code.serialNumber}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=12&width=300&moduleWidth=300'></td>
		</tr>
		</table>
		</td>
		<c:choose>

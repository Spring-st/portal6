...
<br/>
	<table width="430px" height="241px" align="center"  border="0" cellspacing="0" cellpadding="0" >
		...
		<tr height="10%" align="center">
			<td width="10%"	 rowspan="2" style="font-weight: bold;"	>零&nbsp;&nbsp;件&nbsp;&nbsp;号</td>
			<td width="45%"  rowspan="2" style="font-weight: bold; font-size: 20px;">${code.part}</td>
			<td width="8%" style="font-weight: bold;"	>车&nbsp;&nbsp;&nbsp;型</td>
			<td width="17%" style="font-weight: bold;font-size: 15px;">${code.model}</td>
		</tr>
		<tr height="11%" align="center">
			<td width="8%" style="font-weight: bold;font-size: 15px;"	>数&nbsp;&nbsp;&nbsp;量</td>
			<td width="17%" style="font-weight: bold;"><fmt:formatNumber>${code.qty}</fmt:formatNumber>${code.partUnit}</td>
		</tr>
		<tr height="14%" align="center">
			<td width="10%" style="font-weight: bold;"	>零件名称</td>
			<td width="45%" colspan="3" style="font-weight: bold;">${code.partName}</td>
		</tr>
		<tr height="14%" align="center">
			<td width="10%" style="font-weight: bold;"	>供&nbsp;&nbsp;应&nbsp;&nbsp;商</td>
			<td width="50%" style="font-weight: bold;" >${code.supplierName}</td>
			<td width="8%" style="font-weight: bold;"	>批次号</td>
			<td width="17%">&nbsp;</td>
		</tr>
		<tr height="11%" align="center">
			<td width="10%" style="font-weight: bold;"	>打印日期</td>
			<td width="45%" >${X_DATE}</td>
			<td width="8%" style="font-weight: bold;"	>检&nbsp;&nbsp;&nbsp;验</td>
			<td width="17%">&nbsp;</td>
		</tr>
		<tr height="17%" align="center">
			<td width="10%" style="font-weight: bold;"	>条&nbsp;&nbsp;形&nbsp;&nbsp;码</td>
			<td width="45%" colspan="3"><img  style="width: 370px; height: 36px;" src='${path}/CreateBarCode?msg=${code.part}/<fmt:formatDate value="${code.serialDate}" pattern="yyMMdd"/>/${code.serialNumber}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=160&moduleWidth=300'></td>
		</tr>

...
<br/>
	...
	<table width="382px" height="170px" align="center"  border="0" cellspacing="0" cellpadding="0" >
		<tr height="18%" >
			<td class="td1" width="11%">&nbsp;</td>
			<td class="td1 td2" width="66%" colspan="5" align="center" >北京李尔现代坦迪斯汽车系统有限公司<br/>部品识别表</td>
			<td class="td2" width="11%">&nbsp;</td>
		</tr>
		<tr height="22%" align="center">
			<td width="11%"	 rowspan="2" >零&nbsp;&nbsp;件&nbsp;&nbsp;号</td>
			<td width="56%"  rowspan="2"  colspan="4" style="font-weight: bold; font-size: 15px;">${code.part}</td>
			<td width="11%">车&nbsp;&nbsp;&nbsp;型</td>
			<td width="22%" style="font-weight: bold;">${code.model}</td>
		</tr>
		<tr  align="center">
			<td width="11%">数&nbsp;&nbsp;&nbsp;量</td>
			<td width="22%" style="font-weight: bold;"><fmt:formatNumber>${code.qty}</fmt:formatNumber>${code.partUnit}</td>
		</tr>
		<tr height="11%" align="center">
			<td width="11%">零件名称</td>
			<td width="45%" colspan="6" style="font-weight: bold;">${code.partName}</td>
		</tr>
		<tr height="49%" align="center">
			<td width="11%">供&nbsp;&nbsp;应&nbsp;&nbsp;商</td>
		...
		<tr  align="center">
			<!--  
			<td width="13%">打印日期</td>
			<td width="50%" colspan="5">${X_DATE}</td>
			-->
			<td width="11%">批次号</td>
		...
		<tr  align="center">
			...
			<!-- 
			<td width="13%" colspan="2">批次号</td>
			<td width="12%">${box.huCodeOrderNumber}</td>
			 -->
			<td width="11%" colspan="2">流水号</td>
	...
	<%--<table width="321px" height="170px" align="center"  border="0" cellspacing="0" cellpadding="0" >
		<tr height="21%" >
			...
			<td class="td1 td2" width="62%" colspan="2" align="center" style="font-weight: bold;">北京李尔现代坦迪斯汽车系统有限公司<br/>部品识别表</td>
			<td class="td2" width="17%">&nbsp;</td>
		</tr>
		<tr height="10%" align="center">
			<td width="12%"	 rowspan="2">零&nbsp;&nbsp;件&nbsp;&nbsp;号</td>
			<td width="45%"  rowspan="2" style="font-weight: bold; font-size: 15px;">${code.part}</td>
			<td width="12%">车&nbsp;&nbsp;&nbsp;型</td>
			<td width="17%" style="font-weight: bold;">${code.model}</td>
		</tr>
		<tr height="11%" align="center">
			<td width="12%">数&nbsp;&nbsp;&nbsp;量</td>
			<td width="17%" style="font-weight: bold;"><fmt:formatNumber>${code.qty}</fmt:formatNumber>${code.partUnit}</td>
		</tr>
		<tr height="14%" align="center">
			<td width="12%">零件名称</td>
			<td width="45%" colspan="3" style="font-weight: bold;">${code.partName}</td>
		</tr>
		<tr height="14%" align="center">
			<td width="12%">供&nbsp;&nbsp;应&nbsp;&nbsp;商</td>
			<td width="50%" style="font-weight: bold;" >${code.supplierName}</td>
			<td width="12%">批次号</td>
			<td width="17%">&nbsp;</td>
		</tr>
		<tr height="11%" align="center">
		...
		<tr height="17%" align="center">
			...
			<td width="45%" colspan="4"><img  style="width: 380px; height: 23px;" src='${path}/CreateBarCode?msg=${code.part}/<fmt:formatDate value="${code.serialDate}" pattern="yyMMdd"/>/${code.serialNumber}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=160&moduleWidth=300'></td>
		</tr>

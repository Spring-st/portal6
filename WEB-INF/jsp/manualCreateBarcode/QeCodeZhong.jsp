...
<br/>
	...
	<table width="430px" height="241px" align="center"  border="0" cellspacing="0" cellpadding="0" >
		...
		<tr height="10%" align="center">
			...
			<td width="45%"  rowspan="2"  colspan="4" style="font-weight: bold; font-size: 20px;">${code.part}</td>
			<td width="12%">车&nbsp;&nbsp;&nbsp;型</td>
			<td width="17%" style="font-weight: bold;font-size: 15px;">${code.model}</td>
		</tr>
		<tr height="11%" align="center">
			<td width="12%">数&nbsp;&nbsp;&nbsp;量</td>
			<td width="17%" style="font-weight: bold;font-size: 15px;"><fmt:formatNumber>${code.qty}</fmt:formatNumber>${code.partUnit}</td>
		</tr>
		...
		<tr height="14%" align="center">
			...
			<td rowspan="3">
				<img  style=" width: 100px;height: 100px;" src='${path}/CreateQrCode?msg=${code.part}&barType=CODE128&checkCharacter=n&checkCharacterInText=n&height=9&width=80&moduleWidth=80'> 
			</td>
		</tr>
		<tr height="11%" align="center">
			<td width="12%">批次号</td>

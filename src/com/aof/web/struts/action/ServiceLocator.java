...
public class ServiceLocator
{
    ...
    public static BeanLoader2 getBeanLoader(HttpServletRequest request) {
        return (BeanLoader2)getBean("beanLoader2", request);
    }
    ...
    public static PortalShipOrderImportRecordManager portalShipOrderImportRecordManager(HttpServletRequest request) {
        return (PortalShipOrderImportRecordManager)getBean("portalShipOrderImportRecordManager", request);
    }
